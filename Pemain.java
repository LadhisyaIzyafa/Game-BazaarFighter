...
class Pemain implements DapatDiserang {
    ...
    Pemain(String nama) {
        ...
        this.gold      = GameConfig.GOLD_AWAL;  
        this.inventory = new ArrayList<>();
    }

    // Dibuat oleh: Ladhisya - Custom Exception Handling
    void beliItem(Item item, int hargaFinal) throws GoldKurangException {
    if (gold < hargaFinal) {
        ...
        System.out.println(
            "Berhasil membeli " + item.getNama() +
            " dengan harga Rp" + hargaFinal + "!"
        );
    }
