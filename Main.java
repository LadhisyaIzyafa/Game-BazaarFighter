// Dibuat oleh: Nadiya   - Kerangka Antarmuka & Alur Program
// Digabungkan oleh: Ladhisya - Proses Merge Tim
import java.util.*;
...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        while (isRunning && pemain.isHidup()) {
            ...
            // Dibuat oleh: Ladhisya - Try-Catch Utama
            try {
